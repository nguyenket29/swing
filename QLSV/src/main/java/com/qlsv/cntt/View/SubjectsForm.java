 ...
 * @author NguyenCongPC
 */
public class SubjectsForm extends javax.swing.JPanel {
    ...
    private void initTable() {
        ...
        tableModel.setColumnIdentifiers(new String[]{"Mã Môn Học", "Tên Môn Học",
            "Số tín chỉ"});
        ...
        try {
            ...
            while (rs.next()) {
                String[] row = new String[]{
                    rs.getString("MaMh"), rs.getString("TenMh"), rs.getString("TinChi")
                };
    ...
    private boolean search() {
        ...
        if (con != null) {
            try {
                ...
                ps.setString(1, txtMaMh.getText());
                ResultSet rs = ps.executeQuery();
                while (rs.next()) {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(2, 2, 2)
                        .addComponent(txtMon, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(txtMaMh, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(75, 75, 75)
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        Validator.validatorEmpty(txtMaMh, builder, "Mã môn học không được để trống");
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        sj.setMaMon(txtMaMh.getText());
        sj.setTenMon(txtMon.getText());
        sj.setTinChi(Integer.parseInt(txtTinChi.getText()));
        SubjectsDAO dao = new SubjectsDAO();
        try {
            if (dao.update(sj)) {
                MesageHepler.showMessageDialog(menuForm, "Môn học Đã Được Chỉnh Sửa", "Thông báo !");
            } else {
                MesageHepler.showConfirmDialog(menuForm, "Môn học chưa được chỉnh sửa", "Cảnh báo !");
            }
            showAll();
        } catch (Exception ex) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            ...
            SubjectsDAO dao = new SubjectsDAO();
            if (dao.save(sj)) {
                MesageHepler.showMessageDialog(menuForm, "Môn học Đã Được Thêm", "Thông báo !");
            } else {
                MesageHepler.showConfirmDialog(menuForm, "Môn học chưa được thêm", "Cảnh báo !");
            }
            showAll();
        } catch (Exception e) {
            e.printStackTrace();
